...
- Download certificate: https://codeberg.org/ashpynov/AnyFSE/releases/download/v0.90.1/Artem.Shpynov.cer and open it.
...
4. Now you can dowload and install appx package https://codberg.org/ashpynov/AnyFSE/releases/download/v*version*/AnyFSE-*version*.appx
